...
| 1 | [ローカル成果物を検証](01_local_validation.md) | asset `1.4.4`、Python 264件＋Chat UI 21件（合計285件）を`SUCCESS` |
...
| 8 | [MLflowとDatabricks Appを配置](08_mlflow_and_app.md) | 評価質問選択／孤児Chat回復版asset `1.4.4`のDeploymentを`SUCCESS` |
| 9 | [アプリをend-to-end確認](09_end_to_end.md) | 質問1件の選択評価がSUCCESS。30分超の孤児Chat run 2件を回復し、PDF削除HTTP 202、後継Variant 2件のREADY、削除PDF hit 0を確認。SSO済み4画面、TTFT、残り7 profileはPENDING |
