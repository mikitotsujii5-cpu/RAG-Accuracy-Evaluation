...
| 1 | [ローカル成果物を検証](01_local_validation.md) | asset `1.8.1`のPython 344件とUI 65件、合計409件を`SUCCESS` |
...
| 8 | [MLflowとDatabricks Appを配置](08_mlflow_and_app.md) | asset `1.8.1`をfield-eng-eastへ配置し、deployment／App／compute／binding 7件、health、remote 4画面を`SUCCESS` |
