...
| 1 | [ローカル成果物を検証](01_local_validation.md) | asset `1.5.1`のUI 40件を`SUCCESS`。Python 344件はasset `1.4.9`の記録 |
...
| 8 | [MLflowとDatabricks Appを配置](08_mlflow_and_app.md) | GitHub `main/app`からasset `1.5.1`をfield-eng-eastへ配置。deployment／App／compute／health／binding 7件を`SUCCESS` |
